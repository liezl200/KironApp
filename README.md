## Prerequisites
### To Develop the App for either iOS or Android
...
- This command will do that for you: `cd android && touch local.properties && echo "sdk.dir = /Users/$USER/Library/Android/sdk" >> local.properties && cd ..`
...
3. Run `sudo react-native run-android`
...
If you see this, there is a very good chance that you have a permissions problem. You may have to issue `sudo chown -R <user>:<group> KironApp/node_modules/` to prevent these errors. 
